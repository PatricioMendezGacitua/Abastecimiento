	...
	return {
		...
		generarJsonData: function (datos, estructura, size, contentType) {
			return new Promise(function (resolve) {
				...
				var title = datos.NOMBRE_ARCHIVO;
				...
				var jsonArray = [{
...

					{
						...
						"APP": "",
						"DOCUMENT_NAME": "",
						"NODE_NAME": datos.NUMERO_RESERVA,
...

					{
						"CONTAINS_FILE": true,
						"DATE": date,
						"APP": "Abastecimiento_Outbound",
						"DOCUMENT_NAME": "imagenes_reserva_" + datos.NUMERO_RESERVA,
						"NODE_NAME": "",
		...
		consultaIds: function (datos) {
			...
			return new Promise(function (resolve) {
					...
					jsonMetadataManual = [{
						...
						{
							"ATTRIBUTE": "NUMERO RESERVA",
							"VALUE": datos.NUMERO_RESERVA
						},

						{
							"ATTRIBUTE": "NUMERO MATERIAL",
							"VALUE": datos.NUMERO_MATERIAL
						},

						{
							"ATTRIBUTE": "DOCUMENTO SALIDA",
							"VALUE": datos.DOCUMENTO_SALIDA
						},
